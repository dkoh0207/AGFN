            ...
            try:
                ...
                if hps.offline_data:
                    ...
                    info_vals = {"Total loss ":loss_val,
                        ...
                        "Percent_unique_in_batch":gfn_batch.unique_percent,
                        "Percent_novel_cumulative":gfn_batch.novel_percent,
                        "Top-10 mean reward": gfn_batch.top10_reward,
                        "Top-100 mean reward": gfn_batch.top100_reward,
                        "Top-10 mean docking score": gfn_batch.top10_affinity,
                        "Top-100 mean docking score": gfn_batch.top100_affinity,
                        "Average traj len online": gfn_batch.avg_batch_len,
                        "Average fwd_logprob": gfn_batch.avg_fwd_logprob.item(),
                        "Average bck_logprob": gfn_batch.avg_bck_logprob.item(),
